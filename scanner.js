...
class Scanner {
    ...
    scan() {
        ...
        execSync(`echo {\\\"scan\\\":[\`rtl_power -f ${this.freq_init}e6:${this.freq_end}e6:${this.freq_step}e3 -g 30 -i 1 -1 -d 0 | awk '{print"["substr($0, index($0,$3))"],"}' | xargs | sed 's/.$//' \`]} > teste.json`);
